...
User_age = "40 year old" # old, young, adult, kid, baby 
User_height = "medium height" # short, medium, tall
User_weight = "underweight" # underweight, normal, plus size 
...
# # Paths to image files (imgur-hosting service)
# top_image_path = "https://imgur.com/u5qraQp"
# bottom_image_path = "https://imgur.com/pbNo5me"


top_image_path = "https://assets.ajio.com/medias/sys_master/root/20230624/cUGt/64966b51a9b42d15c9ddd4c6/-473Wx593H-465199743-black-MODEL2.jpg"
bottom_image_path = "https://imagescdn.planetfashion.in/img/app/product/7/780119-9036378.jpg"
face_image_path ='https://preview.redd.it/cfvgxcgpzr261.jpg?auto=webp&s=2395221e8393e2a288b5db6235b20f50451990d1'
...
#basic API Endpoint Reference code 
...
output_image_temp_path = output_image_temp[0]
...
output_image = replicate.run(
            ...
            input={
                    ...
                    "cn_img3": face_image_path,
                    "cn_stop3": 0.85,
                    "cn_weight3" : 1.1,
                    "cn_type3": "FaceSwap",

                    "cn_img4": output_image_temp_path,
                    "cn_stop4": 0.8,
                    "cn_weight4" : 0.8,
                    "cn_type4": "ImagePrompt",
                    ...
                    "guidance_scale": 3,
                    "refiner_switch": 0.5,
                    "negative_prompt": "unrealistic,mutilated pupils,deformed eyes,saturated, high contrast, big nose, painting, drawing, sketch, cartoon, anime, manga, render, CG, 3d, watermark, signature, label",
                    "style_selections": "Fooocus V2,Fooocus Photograph,Fooocus Negative",
                    "uov_upscale_value": 0,
                    "outpaint_selections": "",
                    "outpaint_distance_top": 0,
